...
if(isset($_POST['btn'])){
    ...
    $add->edit($form);    //// calling edit function from function.php page
...
<body>
    ...
    <div class="crud crud_2">
        ...
        <div class="crud_form ">
            ...
            <form action="#" method="get" class="from_id">

                <div class="row mb-3 from_id">
                ...
                <input type="submit" value="  SHOW  " name="btn_1" class="btn btn-dark" name="" id="" style="    margin: 19px 25px 42px 105px;">


            </form>

        <?php if(isset($_GET['btn_1'])){    ?>
