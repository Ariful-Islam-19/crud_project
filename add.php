...
if(isset($_POST['btn'])){
    ...
    $form=array("$sname","$saddres",$sclass,"$sphone");
            ...
            <form action="#" method="post">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                      ...
                      <input type="text" name="address" class="form-control" id="colFormLabel" placeholder="Address">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                      ...
                      <input type="number" name="phone" class="form-control" id="colFormLabel" placeholder="Phone">
